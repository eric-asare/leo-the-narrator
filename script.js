// Save second-page and third-page buttons as variables
...
let stories = [
    ...
    'We were hunted by the Massai Tribe',
    'Now we live in harmony and they protect us.'
];

let lionDiv = document.getElementById('lion-div');
let lionText = document.getElementById('lion-text');
...
function changeText() {
    ...
    // Set the text of lion-text element depending on which section the user has currently scrolled to
    lionText.innerHTML = stories[sectionNum];
    // Map vertical scroll position to the horizontal position of the lion
    lionDiv.style.left = pos / (height * 3) * width + 'px';
